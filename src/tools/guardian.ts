  ...
  server.registerTool(
    'azeth_whitelist_protocol',
    {
      description: [
        ...
        'Whitelist additions require guardian co-signature for security. Self-guardian accounts',
        '(guardian == owner) co-sign automatically; a distinct guardian must approve via',
        'AZETH_GUARDIAN_KEY + AZETH_GUARDIAN_AUTO_SIGN=true or XMTP.',
        '',
